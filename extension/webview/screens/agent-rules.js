...
function renderGlobalRules(payload) {
  ...
  document
    .getElementById("toggle-add-global")
    ?.setAttribute("aria-expanded", String(Boolean(ui.showAddGlobal)));
  paint(
          ...
          .map(
            (rule) => `<li class="context-item">
              <div class="context-body">
                ...
                <span class="context-meta"><span class="badge">global</span>${escapeHtml(
                  rule.detail
                )}</span>
              </div>
